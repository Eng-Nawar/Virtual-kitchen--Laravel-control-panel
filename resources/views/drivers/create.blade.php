@extends('layouts.app', ['title' => __('Drivers Management'),'activePage' => 'Drivers Management', 'titlePage' => 'Drivers Management'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0" style="color: gray">{{ __('Drivers Management') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <h6 class="heading-small  mb-4" style="color: white">{{ __('Driver information') }}</h6>
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('drivers.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('name_driver') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name_driver" id="name_driver" class="form-control form-control-alternative{{ $errors->has('name_driver') ? ' is-invalid' : '' }}" placeholder="" value="" required>
                                    ...
                                    <div class="form-group{{ $errors->has('email_driver') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="email" name="email_driver" id="email_driver" class="form-control form-control-alternative{{ $errors->has('email_driver') ? ' is-invalid' : '' }}" placeholder="" value="" required>
                                    ...
                                    <div class="form-group{{ $errors->has('phone_driver') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="phone_driver" id="phone_driver" class="form-control form-control-alternative{{ $errors->has('phone_driver') ? ' is-invalid' : '' }}" placeholder="" value="" required>
