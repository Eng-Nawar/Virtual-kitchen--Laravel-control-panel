                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" method="post" action="{{ route('items.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-center{{ $errors->has('item_image') ? ' has-danger' : '' }}" style="align-items: center">
                                <label class="form-control-label" for="item_image">{{ __('Item Image') }}</label>
                                <div class="text-center" style="align-items: center">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview img-thumbnail" style="align-items: center" data-trigger="fileinput" style="width: 200px; height: 150px;">
