@extends('layouts.app', ['title' => __('Orders'), 'activePage' => 'EditMenu' ,'titlePage'=> 'Menu Edit'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0" style="color: gray">{{ __('Item Management') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <h6 class="heading-small mb-4" >{{ __('Item information') }}</h6>
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('items.update', $item) }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php $image=['name'=>'item_image','label'=>__('Item Image'),'value'=> asset('/storage/product/'.$item->image) ,'style'=>'width: 290px; height:200']; ?>
                    ...
                    <div class="card card-profile shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-new-extras" onClick=>{{ __('Add') }}</button>
                                </div>
                            </div>
                        </div>
                            <div class="table-responsive">
                                    ...
                                    <tbody class="list">
                                        ...
                                        @foreach($item->extras as $extra)
                                            <tr>
                                                ...
                                                <td class="budget">{{$extra->price}}</td>
